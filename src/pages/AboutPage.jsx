    ...
    <div className={styles.pageWrapper}>
      ...
      <div className={styles.container}>        
        ...
        <section className={styles.textSection}>
          ...
          <p>
            I love to learn and take on new challenges, but looking back, it's obvious I was spread too thin. Great ideas require focused execution, and I've always had a wide range of interests—from running an investment club to training for a triathlon. I shelved the startup idea, but I kept coming back to programming. Entrepreneurship and investing taught me how to analyze value, but I didn't want to just read about or pitch ideas. I wanted to <span className={styles.highlight}>engineer</span> them. Today, as software development is shifting, I've embraced LLMs into my workflow as the ultimate leverage. I don't 'vibe code'; I use AI as a sparring partner to accelerate building, organize my thinking and rapidly master new technologies.</p>            
        </section>
